...
import { useGetDocumentDetails } from 'src/api/merchantProfile';

export default function MerchantDocumentDetails() {

    const { documents = [], refreshDocuments } = useGetDocumentDetails();
